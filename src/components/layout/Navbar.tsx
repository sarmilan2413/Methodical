        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3 pl-2">
            <div className="text-right hidden sm:block">
              <p className="text-sm font-semibold text-on-surface leading-none">Alex Sterling</p>
              <p className="text-[10px] text-on-surface-variant font-medium uppercase tracking-wider">Lead Architect</p>
            </div>
            ...
            <Link to="/" className="text-on-surface-variant hover:text-primary text-sm font-medium transition-colors ml-1">
              Logout
            </Link>
          </div>
        </div>
